  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="centro-de-rehabilitacion";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Centro De Rehabilitacion Artros"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="centro-de-rehabilitacion"
          data-primary-color="#49536f"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="centro-de-rehabilitacion";
